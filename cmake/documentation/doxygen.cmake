...
if(DOXYGEN)
	...
	if(NOT DOXYGEN_INPUT_DIRS)
		set(DOXYGEN_INPUT_DIRS lib/persist/interface CACHE STRING "List of input files and folders used to generate Doxygen documentation.")
	endif()
	...
	set_target_properties(docs PROPERTIES ADDITIONAL_CLEAN_FILES ${CMAKE_CURRENT_BINARY_DIR})
else()
